...
This module handles fetching and analyzing performance data from Meta Ads API.
Provides campaign/adset/ad insights, performance reports, metrics analysis, and data export.
"""
...
def set_insights_quiet_mode(quiet: bool):
    """Set quiet mode globally in insights module"""
    global QUIET_MODE
    QUIET_MODE = quiet
...
class InsightsAgent:
    ...
    async def _make_request(self, method: str, url: str, params: Optional[Dict] = None, 
        ...
        try:
            ...
            if e.response.status_code == 429 and retry_count < Config.MAX_RETRIES:  # Rate limit
    ...
    async def get_account_insights(self, account_id: str, 
        ...
        Args:
            ...
            date_preset: Date range preset (last_7d, last_30d, last_90d, etc.)
    ...
    async def get_campaign_insights(self, campaign_id: str,
        ...
        Args:
            ...
            fields: Specific fields to retrieve
            breakdowns: Data breakdowns (age, gender, country, etc.)
    ...
    def parse_insight_metrics(self, insight_data: Dict[str, Any]) -> InsightMetrics:
        ...
        Args:
            insight_data: Raw insight data from API
            
        Returns:
            Parsed InsightMetrics object
        """
    ...
    def calculate_performance_metrics(self, metrics: InsightMetrics) -> Dict[str, Any]:
        ...
        # ROI calculation (requires conversion value)
    ...
    def generate_performance_report(self, insights_list: List[Dict[str, Any]],
        ...
        Args:
            insights_list: List of insight records
            metric_name: Name of metric being reported (Campaign, AdSet, etc.)
...
def validate_breakdown(breakdown: str) -> bool:
    ...
    valid_breakdowns = [
        ...
        "conversion_destination", "frequency_value", "hourly_stats_aggregated_by_advertiser_time_zone",
        "hourly_stats_aggregated_by_audience_time_zone", "impression_device"
    ]
